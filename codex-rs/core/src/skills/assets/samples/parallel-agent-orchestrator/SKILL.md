...
2. Create an agents config JSON (see references/agents-config.md).
3. Run scripts/launch_agents.py to create worktrees, seed report files, and open new terminal windows per agent.
4. Monitor progress in reports/agent-*.md.
5. Merge changes back into the main worktree after review.
